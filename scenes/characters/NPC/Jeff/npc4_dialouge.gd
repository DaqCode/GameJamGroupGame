...
@export_file("res://scenes/characters/NPC/Jeff/jeffDialouge.json") var d_file
...
func load_dialouge():
	var file = FileAccess.open("res://scenes/characters/NPC/Jeff/jeffDialouge.json", FileAccess.READ)
